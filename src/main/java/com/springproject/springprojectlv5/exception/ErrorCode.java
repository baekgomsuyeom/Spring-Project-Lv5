package com.springproject.springprojectlv5.exception;
...
public enum ErrorCode {
    ...
    // 토큰이 있으며 유효한 토큰이나, 해당 사용자의 게시글/댓글/대댓글이 아닌 경우 (즉, 해당 사용자의 토큰이 아닌 경우)
    ...
    NOT_FOUND_REPLY_OR_AUTHORIZATION(HttpStatus.BAD_REQUEST, "대댓글을 찾을 수 없거나 작성자만 삭제/수정할 수 있습니다."),
